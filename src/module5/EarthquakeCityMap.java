...
public class EarthquakeCityMap extends PApplet {
    ...
    public void draw() {
        ...
        if (drawLinesBetweenOceanQuakeAndCities && lastClicked != null) {
            lastClicked.drawLines(this, true, cityMarkers, map);
        }
        addKey();
    ...
    public void mouseClicked() {
        ...
        if (lastClicked != null) {
            ...
            lastClicked.drawLines(this, false, cityMarkers, map);
            lastClicked = null;
            return;
        }
    ...
    private void hideDistantCities(CommonMarker m, List<Marker> otherMarkers, double radius) {
        for (Marker otherMarker : cityMarkers) {
            if (m.getDist((CommonMarker) otherMarker) > radius) {
